...
public class ValidadorArgumento {
    ...
    public static void validarValoresValidos(String valor, String[] valoresValidos,String mensaje){
        boolean auxiliarCoincidencia = true;
        valor = valor.toUpperCase();
        for (String valorValido :valoresValidos) {
            if(valor.equals(valorValido) && auxiliarCoincidencia){
                auxiliarCoincidencia = false;
            }
        }
        if(auxiliarCoincidencia) throw new ExcepcionValorInvalido(mensaje);
    }
